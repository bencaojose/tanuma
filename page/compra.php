...
<div class="bg-white">
    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 class="text-xl font-bold text-gray-900"> Carros aa </h2>  
        ...
        <div class="mt-8 grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
            ...
            ?>
                <div>
                    ...
                    <div class="mt-6">
                 <!-- Botão de compra -->
                        <a href="comprar_carro.php?id_carro=<?php echo $comp['id_carro']; ?>" class="relative flex items-center justify-center rounded-md border border-transparent bg-gray-100 px-8 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200">Comprar</a>
